...
void QAPRSCore::tcpServerRead () {
    ...
    //ј’“”Ќ√!!! клиенты шлют и по несколько пакетов за раз!!!!!
    QByteArray datagram; //ну или же €дро долго чухает, что приход€т еще датаграммы
    QByteArray mesg; //и получаетс€ что в прочитанных данных может быть и больше одного пакета !
    //та же проблема и с реконнектами ui к €дру, наверное: идут сразу две комманды
