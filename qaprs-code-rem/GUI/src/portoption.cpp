...
PortoptionDialog::PortoptionDialog()
{
    ...
    QFile fileConfig("./aprs_servers.xml");
...
void PortoptionDialog::saveButtonClick() {
    ...
    if ((portTypeBox->currentIndex() == 0) or
        (portTypeBox->currentIndex() == 0) or
        (portTypeBox->currentIndex() == 0)) {
    ...
    if ( portType == "AXIP" ) {
        ...
        emit setPortParam( portNumber, "PORT_TYPE", portType );
...
//определяем тип порта
        if ( ( pName == "PORT_TYPE" ) and ( pVal == "AXIP" ) ) {
        ...
        if ( ( pName == "PORT_TYPE" ) and ( pVal == "Inet" ) ) {
        ...
        if ( ( pName == "PORT_TYPE" ) and ( pVal == "AGW" ) ) {
        ...
        if ( ( pName == "PORT_TYPE" ) and ( pVal == "KISS" ) ) {
        ...
        if ( ( pName == "PORT_TYPE" ) and ( pVal == "FLDIGI" ) ) {
        ...
        if ( ( pName == "PORT_TYPE" ) and ( pVal == "VASKA" ) ) {
...
void PortoptionDialog::onProxyCheck(int index) {
    ...
    if ( proxyCheckBox->isChecked() ) {
        ...
        label_103->setEnabled( proxyAuthCheckBox->isChecked() and proxyCheckBox->isChecked() );
        proxyUserEdit->setEnabled( proxyAuthCheckBox->isChecked() and proxyCheckBox->isChecked() );
        label_104->setEnabled( proxyAuthCheckBox->isChecked() and proxyCheckBox->isChecked() );
        proxyPassEdit->setEnabled( proxyAuthCheckBox->isChecked() and proxyCheckBox->isChecked() );
    } else {
